...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("kitten panel --layer top -o background_opacity=0.5 -o window_padding_width=4 zsh -c 'status-bar $COLUMNS'")
  hl.exec_cmd("kitten panel --edge background -o touch_scroll_multiplier=0.0 sh -c 'kitten icat -n ~/.wallpaper && echo -e \"\\x1b[3+T\" && sleep infinity'")
  hl.exec_cmd("ags run")
