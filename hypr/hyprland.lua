...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("status-bar")
  hl.exec_cmd("wallpaper")
  hl.exec_cmd("ags run")
  hl.exec_cmd("udiskie -s")
  hl.exec_cmd("fcitx5")
  hl.exec_cmd("thunderbird", { workspace = 1 })
  hl.exec_cmd("discord --enable-features=UseOzonePlatform --ozone-platform=wayland --enable-wayland-ime", { workspace = 2 })
...
hl.layer_rule({ match = { namespace = "osd" }, no_anim = true, blur = true })
